...
function ViewCart() {
  ...
  const getColorDisplay = (item) => {
    ...
    return (
      String(colorName).charAt(0).toUpperCase() + String(colorName).slice(1)
    );
  };
  ...
  const getAvailableSizes = (item) => {
    ...
    if (
      item.productSizes &&
      Array.isArray(item.productSizes) &&
  ...
  const getAvailableColors = (item) => {
    ...
    if (
      item.productColors &&
      Array.isArray(item.productColors) &&
    ...
    if (productData) {
      ...
      if (productData.color) {
        return [
          { label: productData.color, hex: productData.color_hex || null },
        ];
      }
    }
  ...
  const handleSizeSelect = (item, selectedSize) => {
    const normalizedColor = normalizeColorName(
      item.colorObj?.name || item.colorName || item.color,
    );
  ...
  return (
    <>
      ...
      <section
        style={{ padding: "30px 0", background: "#fafafa", minHeight: "70vh" }}
      >
            ...
            >
              ...
              <Link
                ...
                style={{
                  ...
                  padding: "14px 32px",
                  background:
                    "linear-gradient(135deg, #595959ff 0%, #000000ff 100%)",
                  color: "#fff",
                  borderRadius: "10px",
                  textDecoration: "none",
                  fontWeight: "600",
                    ...
                    >
                      ...
                      <div style={{ flex: 1 }}>
                        ...
                        >
                          ...
                          {hasSizeSelector && (
                            <div
                              className="size-selector-wrapper"
                              style={{
                                display: "inline-flex",
                                alignItems: "center",
                                gap: "6px",
                            ...
                            >
                              ...
                              <select
                                value={product.size || ""}
                                onChange={(e) =>
                                  handleSizeSelect(product, e.target.value)
                                }
                                style={{
                                    ...
                                    {availableColors.map((color) => {
                                      ...
                                      return (
                                        <button
                                          ...
                                          onClick={() =>
                                            handleColorSelect(product, colorObj)
                                          }
                                          onMouseEnter={(e) => {
                                            if (!isSelected) {
